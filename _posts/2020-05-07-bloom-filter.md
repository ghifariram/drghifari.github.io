...
**Warning**! This implementation is for academic purposes only, not intended to be used in the real world/production environment. There have been many implementations of Bloom Filter that you can use them right away e.g Python's [bloom-filter][pybloom] or Google's [Guava][guava].
{: .notice--warning}
